...
- формировала reasoning на русском, КОРОТКОЕ — до 25 слов
  (это страховка от MAX_TOKENS truncate на flash-моделях; русский в Gemini
  токенизируется ~1.5 символа/токен, длинное reasoning легко съедает бюджет)
"""
...
3. Reasoning пиши на русском, ОЧЕНЬ КОРОТКО — одно предложение, до 25 слов. Объясни почему именно это место.
...
6. Возвращай не больше 3 рекомендаций.
